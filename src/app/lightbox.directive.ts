  ...
  constructor() {
    ...
    var duration = function (a: { getDate: (arg0: boolean) => Date | { start_date: Date; end_date: Date; task?: Task | undefined; }; }, b: { getDate: (arg0: boolean) => Date | undefined; }, c: { innerHTML: string; }) {
      var res = gantt.calculateDuration(a.getDate(false), b.getDate(false));
        ...
        var minutes = res % 60;
        c.innerHTML = hours + ' hours ' + minutes + ' minutes';
      };
  
      var calendar_init = function (id: string, data: { date_format: any; skin: any; }, date: Date) {
      ...
      gantt['form_blocks']["dhx_calendar"] = {
        ...
        set_value: function (node: { _cal_start: any; _cal_end: any; lastChild: any; }, value: any, task: { start_date: string | number | Date; end_date: string | number | Date; }, data: any) {
          ...
          if(task.start_date >= start_date){
            ...
            end_date.setHours(end_date.getHours() + 16);
          }
  
          var a = node._cal_start = calendar_init('calendar1', data, start_date);
          var b = node._cal_end = calendar_init('calendar2', data, end_date);
          ...
          (document.getElementById('calendar1')! as HTMLInputElement).value = a.getDate(true);
          (document.getElementById('calendar2')! as HTMLInputElement).value = b.getDate(true);
          duration(a, b, c);
        },
